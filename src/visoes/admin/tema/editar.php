...
<section class="section" style="background: #23272f; min-height: 100vh; padding-top: 2rem;">
    <div class="painel-admin-container">
        <div class="painel-centralizado">
            <div class="tabela-bg">
                <h2 class="title has-text-centered has-text-link-light">Editar Tema</h2>
                <form method="post" style="max-width: 400px; margin: 0 auto;">
                    <div class="field">
                        <label class="label has-text-light">Nome do Tema</label>
                        <div class="control">
                            <input class="input" type="text" name="nome_tema"
                                   value="<?= htmlspecialchars($tema['nome_tema']) ?>" required autofocus>
                        </div>
                    </div>
