...
<section class="section" style="background: #23272f; min-height: 100vh; padding-top: 2rem;">
    <div class="painel-admin-container">
        <div class="painel-centralizado">
            <div class="tabela-bg">
                <h2 class="title has-text-centered has-text-link-light">Editar Disciplina</h2>
                <form method="post" style="max-width: 400px; margin: 0 auto;">
                    <div class="field">
                        <label class="label has-text-light">Nome da Disciplina</label>
                        <div class="control">
                            <input class="input" type="text" name="nome_disciplina"
                                   value="<?= htmlspecialchars($disciplina['nome_disciplina']) ?>" required autofocus>
                        </div>
                    </div>
