                    ...
                    <tbody>
                        <?php foreach ($cursos as $curso): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($curso['criado_em'] ?? '') ?></td>
                                <td><?= htmlspecialchars($curso['actualizado_em'] ?? '') ?></td>
                                <td>
                                ...
                                <td>
                                    <a href="?rota=crud_curso&acao=deletar&id=<?= $curso['id_curso'] ?>" class="button is-danger is-small" onclick="return confirm('Tem a certeza que pretende eliminar este curso?')">
