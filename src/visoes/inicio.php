        ...
        <div class="container has-text-centered">
            ...
            <?php if ($utilizadorLogado): ?>
                <div class="buttons is-centered mt-5">
                    <a href="?rota=exames" class="button is-medium cta-button">
                        <span class="icon"><i class="fas fa-file-alt"></i></span>
                        <span>Meus Exames</span>
                    </a>
                    <a href="?rota=meu_progresso" class="button is-medium cta-button">
                        <span class="icon"><i class="fas fa-chart-bar"></i></span>
                        <span>Meu Progresso</span>
                    </a>
                    <a href="?rota=perfil" class="button is-medium cta-button">
            ...
            <?php else: ?>
                <div class="buttons is-centered mt-5">
                    <a href="?rota=exames_demo" class="button is-medium cta-button">
                        <span class="icon"><i class="fas fa-edit"></i></span>
                        <span>Experimentar Exame</span>
                    </a>
                    <a href="?rota=como_funciona" class="button is-medium cta-button">
                        <span class="icon"><i class="fas fa-info-circle"></i></span>
                        <span>Como Funciona</span>
                    </a>
                    <a href="?rota=registro" class="button is-medium cta-button">
