            ...
            <?php if ($utilizadorLogado): ?>
                <?php if ($nivelAcesso === 'admin'): ?>
                    <div class="buttons is-centered mt-5">
                        ...
                        <a href="?rota=exame_sistema_listar" class="button is-medium is-primary cta-button">
                            <span class="icon"><i class="fas fa-file-alt"></i></span>
                            <span>Gerir Exames</span>
                        </a>
                        <a href="?rota=universidades_listar" class="button is-medium is-link cta-button">
                            <span class="icon"><i class="fas fa-university"></i></span>
                            <span>Gerir Universidades</span>
                        </a>
                    </div>
                <?php else: ?>
                    <div class="buttons is-centered mt-5">
                        <a href="?rota=dashboard_estudante" class="button is-medium cta-button">
                            <span class="icon"><i class="fas fa-file-alt"></i></span>
                            <span>Meus Exames</span>
                        </a>
                        <a href="?rota=meus_resultados" class="button is-medium cta-button">
                            <span class="icon"><i class="fas fa-chart-bar"></i></span>
                            <span>Meu Progresso</span>
                        </a>
                        <a href="?rota=meu_perfil" class="button is-medium cta-button">
